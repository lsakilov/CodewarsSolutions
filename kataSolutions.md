...
[Boardgame Fight Resolve](https://www.codewars.com/kata/58558673b6b0e5a16b000028/train/javascript)
...
function fightResolve(defender, attacker) {
    ...
    if (a == a.toLowerCase() && d != d.toUpperCase() || a == a.toUpperCase() && d != d.toLowerCase()) {
        return -1;
    }
    if (a === 'A' && d === 's' || a === 'a' && d === 'S' || a === 'A' && d === 'a' || a === 'a' && d === 'A' || a === 'A' && d === 'p' || a === 'a' && d === 'P' || a === 'P' && d === 'k' || a === 'p' && d === 'K' || a === 'P' && d === 'a' || a === 'p' && d === 'A' || a === 'P' && d === 'p' || a === 'p' && d === 'P' ||
        a === 'S' && d === 'k' || a === 's' && d === 'K' || a === 'S' && d === 's' || a === 's' && d === 'S' || a === 'S' && d === 'p' || a === 's' && d === 'P' || a === 'K' && d === 'k' || a === 'k' && d === 'K' || a === 'K' && d === 's' || a === 'k' && d === 'S' || a === 'K' && d === 'a' || a === 'k' && d === 'A') {
        return a;
    }
    if (a === 'A' && d === 'k' || a === 'a' && d === 'K' || a === 'P' && d === 's' || a === 'p' && d === 'S' || a === 'S' && d === 'a' || a === 's' && d === 'A' || a === 'K' && d === 'p' || a === 'k' && d === 'P') {
        return d;
    }
}    
```
...
```javascript
const square = (side) => {return side * side};
```